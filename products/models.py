...
class Product(models.Model):
    ...
    reward_points_credit = models.IntegerField(_("Reward Points Credit"),
                                               default=0)
...
class Pricing(models.Model):
    ...
    base_price = models.DecimalField(_("Base Price"),
                                     max_digits=10,
                                     decimal_places=2)
    date_created = models.DateTimeField(_("Date Created"), auto_now_add=True)
    date_expired = models.DateTimeField(_("Date Expired"),
                                        blank=True,
                                        null=True)
